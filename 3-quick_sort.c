...
/**
 * lomuto_partition - Order a subset of the array of integers according to
 ...
 * @array: An array of the ints to be sorted.
 * @size: size of the array.
...
/**
 * quick_sort - Sort an array of ints in an ascending
 *              order using the quicksort algorithm.
 * @array: An array of ints.
 * @size: Size of the array.
 *
 * Description: Using the Lomuto Partition Scheme. prints
